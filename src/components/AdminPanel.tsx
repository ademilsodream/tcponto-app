...
const AdminPanel: React.FC<AdminPanelProps> = ({ onBack }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (savedEmployees) {
        ...
        console.log('AdminPanel: Funcionários carregados:', parsedEmployees);
  ...
  const addSampleLocationData = () => {
    console.log('AdminPanel: Adicionando dados de localização...');
  ...
  const renderContent = () => {
    console.log('AdminPanel: Renderizando conteúdo, activeTab:', activeTab);
    ...
    try {
      ...
      console.error('AdminPanel: Erro ao renderizar conteúdo:', error);
      return (
        <div className="p-4">
          <Alert>
            <AlertDescription>
              Erro ao carregar o conteúdo. Verifique o console para mais detalhes.
            </AlertDescription>
          </Alert>
        </div>
      );
  ...
  console.log('AdminPanel: Renderizando componente principal');
