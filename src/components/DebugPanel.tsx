...
const DebugPanel: React.FC = () => {
  ...
  const exportLogs = () => {
    ...
    a.href = url;
    a.download = `tcponto-debug-${new Date().toISOString().split('T')[0]}.log`;
  ...
  useEffect(() => {
    // Mostrar painel de debug em desenvolvimento ou se houver erros
                    ...
                    return (
                      ...
                      >
                        <div className="flex justify-between items-start">
                          ...
                          <Badge 
                            variant={parsed.level === 'ERROR' ? 'destructive' : 'secondary'}
                            className="text-xs"
                          >
                            {parsed.level}
                          </Badge>
