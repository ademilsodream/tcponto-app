...
  const getFieldLabel = useCallback((field: 'clockIn' | 'lunchStart' | 'lunchEnd' | 'clockOut'): string => {
    const labels = {
      clockIn: 'Entrada',
...
          {/* Use grid-cols-3 directly for skeleton */}
...
      {/* Pending Requests - Fixed 3-Column Grid */}
      <Card className="p-0">
...
                <div key={`${group.employeeId}-${group.date}`} className="border rounded-md p-2 bg-yellow-50 border-yellow-200 text-xs flex flex-col justify-between">
                  <div>
...
                      className="bg-green-600 hover:bg-green-700 text-xs h-5 px-1.5 flex-1"
                    >
...
                      className="text-xs h-5 px-1.5 flex-1"
                    >
...
                <div key={request.id} className="border rounded-md p-2 bg-gray-50 border-gray-200 text-xs flex flex-col justify-between">
                  <div>
                    <div className="flex justify-between items-start mb-1">
                      <div>
                        <h4 className="font-medium text-gray-900 flex items-center gap-1 text-sm">
...
                      )}
                  </div>
                  <p className="text-right text-[9px] text-gray-500 mt-auto pt-1">
