...
import { calculateWorkingHours } from '@/utils/timeCalculations'; // Assume que esta função retorna números precisos
      ...
      for (const employee of dbEmployees) {
        ...
        if (timeRecords && timeRecords.length > 0) {
          ...
          validRecords.forEach(record => {
            ...
            // *** CORREÇÃO AQUI: Arredondar as horas de CADA DIA antes de somar ***
